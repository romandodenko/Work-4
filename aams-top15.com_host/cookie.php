...
?>
    <main>
      <section class="terms">
        <div class="container">
          <h1>Cookie Policy per aams-top15.com</h1>

          <p>Questa è la Cookie Policy per aams-top15.com, accessibile da aams-top15.com</p>
          ...
          <ul>
            ...
            <li>
              ...
              <p>Per offrirti un'ottima esperienza su questo sito, forniamo la funzionalità per impostare il tuo
                preferenze su come questo sito viene eseguito quando lo si utilizza. Per ricordare le tue preferenze
                dobbiamo impostare
                cookie in modo che queste informazioni possano essere richiamate ogni volta che interagisci con una
                pagina è interessata dal tuo
                preferenze.</p>
            </li>
          ...
          <ul>
            ...
            <li>
              <p>Utilizziamo anche pulsanti e/o plug-in dei social media su questo sito che ti consentono di connetterti
                con il tuo social
                rete in vari modi. Affinché questi funzionino i seguenti siti di social media tra cui; {Elencare i
                social
                reti di cui hai integrato le funzionalità con il tuo sito?:12}, imposterà i cookie attraverso il nostro
                sito che
                possono essere utilizzati per migliorare il tuo profilo sul loro sito o contribuire ai dati che
                detengono per vari
                finalità descritte nelle rispettive informative sulla privacy.</p>
            </li>
