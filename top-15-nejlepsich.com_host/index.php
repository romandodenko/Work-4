      ...
      <div class="container">
        ...
        <ul class="hry__list">
          ...
          <li class="hry__item">
            <a href="game-3.php">
              <picture>
                <source srcset="./img/game-3.webp" type="image/webp"><img src="./img/game-3.jpg" alt="Image"></picture>
            </a>
          </li>
        </ul>
      </div>
  ...
  <div class="popup">
    ...
    <div class="popup__body">
      <form class="popup__form" action="/">
        <p class="popup__text">Naše hry jsou určeny pro DOSPĚLÉ publikum od 18 let. Kliknutím na
        ...
        <a class="popup__button" href="main.php">Souhlasit</a>
      </form>
    </div>
  </div>
  <?php
