...
?>
      <div class="page__bottom">
        <main>
          <section class="terms">
            <div class="container">
              <h1><strong><span>Terms and Conditions</span></strong></h1>

              <p>Welcome to pokies-canada-2023.com!</p>

              <p>These terms and conditions outline the rules and regulations for the use of pokies-canada-2023.com's
                Website, located at pokies-canada-2023.com.</p>

              <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                pokies-canada-2023.com if you do not agree to take all of the terms and conditions stated on this page.
              </p>
              ...
              <h2><strong><span>Cookies</span></strong></h2>

              <p>We employ the use of cookies. By accessing pokies-canada-2023.com, you agreed to use cookies in
                agreement with the pokies-canada-2023.com's Privacy Policy. </p>
              ...
              <h2><strong><span>License</span></strong></h2>

              <p>Unless otherwise stated, pokies-canada-2023.com and/or its licensors own the intellectual property
                rights for all material on pokies-canada-2023.com. All intellectual property rights are reserved. You
                may access this from pokies-canada-2023.com for your own personal use subjected to restrictions set in
                these terms and conditions.</p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from pokies-canada-2023.com</li>
                <li>Sell, rent or sub-license material from pokies-canada-2023.com</li>
                <li>Reproduce, duplicate or copy material from pokies-canada-2023.com</li>
                <li>Redistribute content from pokies-canada-2023.com</li>
              </ul>

              <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. pokies-canada-2023.com does not filter, edit, publish or review Comments
                prior to their presence on the website. Comments do not reflect the views and opinions of
                pokies-canada-2023.com,its agents and/or affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent permitted by applicable laws,
                pokies-canada-2023.com shall not be liable for the Comments or for any liability, damages or expenses
                caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
                this website.</p>

              <p>pokies-canada-2023.com reserves the right to monitor all Comments and to remove any Comments which can
              ...
              <p>You hereby grant pokies-canada-2023.com a non-exclusive license to use, reproduce, edit and authorize
                others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>

              <h2><strong><span>Hyperlinking to our Content</span></strong></h2>
              ...
              <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                ...
                absence of pokies-canada-2023.com; and (d) the link is in the context of general resource information.
              </p>
              ...
              <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to pokies-canada-2023.com. Please include your name,
              ...
              <p>No use of pokies-canada-2023.com's logo or other artwork will be allowed for linking absent a trademark
                license agreement.</p>

              <h2><strong><span>Reservation of Rights</span></strong></h2>
              ...
              <h2><strong><span>Removal of links from our website</span></strong></h2>
              ...
              <h2><strong><span>Disclaimer</span></strong></h2>
