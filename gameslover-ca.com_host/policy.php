...
<head>
  ...
  <title>Gameslover ca - Privacy Policy</title>
</head>
    ...
    <div class="page__content">
      ...
      <div class="page__body">
        <main>
          ...
          <section class="terms">
            <div class="container">
              <h1>Privacy Policy for gameslover-ca.com</h1>

              <p>At gameslover-ca.com, accessible from gameslover-ca.com, one of our main priorities is the privacy of
                our visitors. This Privacy Policy document contains types of information that is collected and recorded
                by gameslover-ca.com and how we use it.</p>
              ...
              <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in gameslover-ca.com. This policy is not
              ...
              <p>gameslover-ca.com follows a standard procedure of using log files. These files log visitors when they
              ...
              <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                are used in their respective advertisements and links that appear on gameslover-ca.com, which are sent
              ...
              <p>Note that gameslover-ca.com has no access to or control over these cookies that are used by third-party
                advertisers.</p>

              <h2>Third Party Privacy Policies</h2>

              <p>gameslover-ca.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are
