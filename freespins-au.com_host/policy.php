    ...
    <main>
      <section class="terms">
        <div class="terms__container container">
          <h1>Privacy Policy for freespins-au.com</h1>

          <p>At freespins-au.com, accessible from freespins-au.com, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            freespins-au.com and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in freespins-au.com. This policy is not
          ...
          <p>freespins-au.com follows a standard procedure of using log files. These files log visitors when they visit
          ...
          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on freespins-au.com, which are sent directly
          ...
          <p>Note that freespins-au.com has no access to or control over these cookies that are used by third-party
            advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>freespins-au.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
