    ...
    <main>
      <section class="terms">
        <div class="terms__container container">
          ...
          <p>Welcome to freespins-au.com!</p>

          <p>These terms and conditions outline the rules and regulations for the use of freespins-au.com's Website,
            located at freespins-au.com.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            freespins-au.com if you do not agree to take all of the terms and conditions stated on this page.</p>
          ...
          <p>We employ the use of cookies. By accessing freespins-au.com, you agreed to use cookies in agreement with
            the freespins-au.com's Privacy Policy. </p>
          ...
          <p>Unless otherwise stated, freespins-au.com and/or its licensors own the intellectual property rights for all
            material on freespins-au.com. All intellectual property rights are reserved. You may access this from
            freespins-au.com for your own personal use subjected to restrictions set in these terms and conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from freespins-au.com</li>
            <li>Sell, rent or sub-license material from freespins-au.com</li>
            <li>Reproduce, duplicate or copy material from freespins-au.com</li>
            <li>Redistribute content from freespins-au.com</li>
          </ul>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. freespins-au.com does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and opinions of freespins-au.com,its agents
            and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions.
            To the extent permitted by applicable laws, freespins-au.com shall not be liable for the Comments or for any
          ...
          <p>freespins-au.com reserves the right to monitor all Comments and to remove any Comments which can be
          ...
          <p>You hereby grant freespins-au.com a non-exclusive license to use, reproduce, edit and authorize others to
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            of freespins-au.com; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to freespins-au.com. Please include your name, your
          ...
          <p>No use of freespins-au.com's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
