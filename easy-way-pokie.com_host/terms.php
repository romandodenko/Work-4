      ...
      <section class="terms">
        <div class="terms__container container">
          <div class="terms__column">
            ...
            <p>Welcome to easy-way-pokie.com!</p>

            <p>These terms and conditions outline the rules and regulations for the use of easy-way-pokie.com's Website,
              located at easy-way-pokie.com.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
              easy-way-pokie.com if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>We employ the use of cookies. By accessing easy-way-pokie.com, you agreed to use cookies in agreement
              with the easy-way-pokie.com's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, easy-way-pokie.com and/or its licensors own the intellectual property rights for
              all material on easy-way-pokie.com. All intellectual property rights are reserved. You may access this
              from easy-way-pokie.com for your own personal use subjected to restrictions set in these terms and
              conditions.</p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from easy-way-pokie.com</li>
              <li>Sell, rent or sub-license material from easy-way-pokie.com</li>
              <li>Reproduce, duplicate or copy material from easy-way-pokie.com</li>
              <li>Redistribute content from easy-way-pokie.com</li>
            </ul>

            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
              certain areas of the website. easy-way-pokie.com does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the views and opinions of easy-way-pokie.com,its
              agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
              opinions. To the extent permitted by applicable laws, easy-way-pokie.com shall not be liable for the
            ...
            <p>easy-way-pokie.com reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>You hereby grant easy-way-pokie.com a non-exclusive license to use, reproduce, edit and authorize others
          ...
          <div class="terms__column">
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
              ...
              absence of easy-way-pokie.com; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
              website, you must inform us by sending an e-mail to easy-way-pokie.com. Please include your name, your
            ...
            <p>No use of easy-way-pokie.com's logo or other artwork will be allowed for linking absent a trademark
              license agreement.</p>
