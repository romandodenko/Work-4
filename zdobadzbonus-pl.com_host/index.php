            ...
            <div class="container">
              ...
              <ul class="benefits__list">
                ...
                <li class="benefits__item">
                  ...
                  <p class="benefits__text">
                    Możesz grać w nasze gry swobodnie na dowolnym urządzeniu iz dowolnego miejsca na świecie, jedyne
                    czego
    ...
    <div class="popup">
      ...
      <div class="popup__body">
        <form class="popup__form" action="/">
          <p class="popup__text">Nasze gry są przeznaczone dla DOROSŁYCH widzów w wieku 18 lat i starszych. Klikając w
